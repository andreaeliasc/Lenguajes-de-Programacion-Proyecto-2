...
### Programa Nodo que define la estructura que almacenara cada Nodo generado en nuestra construccion de automatas a modo de CLASE
### El nodo alamacena principalmente:
### - Simbolos
### - Estados
### - Estado Inicial
### - Estados Finales
