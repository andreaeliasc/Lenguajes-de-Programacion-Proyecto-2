...
## Andrea Elias
## 17048
### Programa que se encarga de la lectura de una expresion para proceder a armar el arbol en forma de una estructura de listas (Mejorado)

### Se importan librerias para
### - Math: Uso del numero infinito
import math
